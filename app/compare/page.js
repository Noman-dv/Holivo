...
export const metadata = {
  ...
  description: 'Compare your selected flights and hotels',
}
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-6 md:mb-8">
          ...
          <p className="text-base sm:text-lg text-gray-600">
            Review and compare your selected flights and hotels
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-600 mb-4">
            Select flights and hotels to see a combined trip cost before you complete your booking on partner sites.
          </p>
