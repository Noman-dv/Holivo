...
/**
 * Footer Component
 * Comprehensive footer with logo, links, and contact information
 */
export default function Footer() {
  ...
  const footerLinks = {
    ...
    services: [
      ...
      { label: 'AI Holiday', href: ROUTES.AI_HOLIDAY },
    ],
  }
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-block mb-4">
              <span className="text-2xl md:text-3xl font-bold text-white hover:text-teal-100 transition-colors">
                ✈️ Holivo
              </span>
            </Link>
        ...
        <div className="border-t border-teal-500 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-teal-100">
            <p>&copy; {currentYear} Holivo. All rights reserved.</p>
